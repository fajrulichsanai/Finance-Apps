...
export default function MonthOverMonth() {
  return (
    <InsightCard>
      <div className="text-[13px] font-bold text-[#0d0d2b] mb-3.5">Perbandingan Bulan</div>
      ...
      <div className="flex gap-3">
        <div className="flex-1">
          <div className="text-[10px] text-gray-400 mb-0.5">SELISIH TABUNGAN</div>
          <div className="text-base font-extrabold text-[#1a9e6e]">+$420.00</div>
        </div>
        <div className="w-px bg-[#f0f0f5]" />
        <div className="flex-1">
          <div className="text-[10px] text-gray-400 mb-0.5">RATA-RATA HARIAN</div>
